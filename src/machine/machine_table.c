...
const machine_t machines[] = {
    ...
    { "[8088] Atari PC 3",                           "ataripc3",            MACHINE_TYPE_8088,       MACHINE_CHIPSET_DISCRETE,            machine_xt_ataripc3_init,            0, 0, MACHINE_AVAILABLE, 0 , CPU_PKG_8088,                                    CPU_BLOCK_NONE, 0, 0, 0, 0, 0, 0, MACHINE_PC,        MACHINE_FLAGS_NONE,   64,   640,  64,    0, NULL, NULL },
    ...
    { "[NEAT] Atari PC 4",                         "ami286",           MACHINE_TYPE_286,        MACHINE_CHIPSET_NEAT,                machine_at_ataripc4_init,         0, 0, MACHINE_AVAILABLE, 0 , CPU_PKG_286,                                     CPU_BLOCK_NONE, 0, 0, 0, 0, 0, 0, MACHINE_AT, MACHINE_FLAGS_NONE, 512,  8192, 128,  127, NULL, NULL },
    ...
    { "[i440BX] ASUS P2B-LS (coreboot)",                          "p2bls_coreboot",            MACHINE_TYPE_SLOT1,      MACHINE_CHIPSET_INTEL_440BX,         machine_at_p2bls_coreboot_init,            0, 0, MACHINE_AVAILABLE, 0 , CPU_PKG_SLOT1,                     CPU_BLOCK_NONE,                       50000000, 112121212, 1300, 3500, 1.5, 8.0, MACHINE_PS2_AGP, MACHINE_IDE_DUAL | MACHINE_COREBOOT, 8192, 1048576, 8192, 255, NULL, NULL },
    /* Has a Winbond W83977EF Super I/O chip with on-chip KBC with AMIKey-2 KBC
       firmware. */
    ...
    { "[i440BX] ASUS P3B-F (coreboot)",                           "p3bf_coreboot",             MACHINE_TYPE_SLOT1,      MACHINE_CHIPSET_INTEL_440BX,         machine_at_p3bf_coreboot_init,             0, 0, MACHINE_AVAILABLE, 0 , CPU_PKG_SLOT1,                     CPU_BLOCK_NONE,                       66666667, 150000000, 1300, 3500, 1.5, 8.0, MACHINE_PS2_AGP, MACHINE_IDE_DUAL | MACHINE_COREBOOT, 8192, 1048576, 8192, 255, NULL, NULL },
    /* Has a Winbond W83977EF Super I/O chip with on-chip KBC with AMIKey-2 KBC
       firmware. */
    ...
    { "[Intel i815EP] Tyan Tomcat i815T",              "s2080",            MACHINE_TYPE_SOCKET370,       MACHINE_CHIPSET_INTEL_I815EP,        machine_at_s2080_init,            0, 0, MACHINE_AVAILABLE, 0 , CPU_PKG_SOCKET370,                 CPU_BLOCK_NONE,        			      66666667, 133333333, 1300, 3500, 1.5, 15.0, MACHINE_PS2_NOISA,   MACHINE_IDE_DUAL, 32768, 524288, 32768, 255, NULL, NULL },
