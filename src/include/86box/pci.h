...
enum {
    ...
    PCI_CARD_NORTHBRIDGE_SEC = 1, /* i450KX */
/*
    PCI_CARD_NORTHBRIDGE_TER = 2, // i450GX
    PCI_CARD_NORTHBRIDGE_QUA = 3, // i450GX
*/
...
enum {
    ...
    PCI_ADD_NORTHBRIDGE_SEC = 1, /* i450KX */
/*
    PCI_ADD_NORTHBRIDGE_TER = 2, // i450GX
    PCI_ADD_NORTHBRIDGE_QUA = 3, // i450GX
*/
    PCI_ADD_AGPBRIDGE       = 2,
