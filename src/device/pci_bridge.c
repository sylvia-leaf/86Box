...
#define AGP_BRIDGE_VIA_8391    0x11068391
...
/* UNVERIFIED: Device 1 Rx44 AGP control register */
const device_t via_vt8371_agp_device = {
    .name          = "VIA Apollo KX133 AGP Bridge",
    .internal_name = "via_vt8371_agp",
    .flags         = DEVICE_PCI,
    .local         = AGP_BRIDGE_VIA_8391,
    .init          = pci_bridge_init,
    .close         = NULL,
    .reset         = pci_bridge_reset,
    .available     = NULL,
