...
static int opCVTTPD2PI_mm_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3)
    {
        cpu_state.MM[cpu_reg].l[0] = floor(XMM[cpu_rm].d[0]);
        cpu_state.MM[cpu_reg].l[1] = floor(XMM[cpu_rm].d[1]);
        CLOCK_CYCLES(1);
    }
    else
    {
        ...
        cpu_state.MM[cpu_reg].l[0] = floor(dst_real[0]);
        cpu_state.MM[cpu_reg].l[1] = floor(dst_real[1]);
        CLOCK_CYCLES(2);
    }
    return 0;
}
...
static int opCVTTSD2SI_l_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3)
    {
        setr32(cpu_reg, floor(XMM[cpu_rm].d[0]));
        CLOCK_CYCLES(1);
    }
    else
    {
...
static int opCVTSD2SI_l_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3)
    {
        setr32(cpu_reg, sse_round_double_to_int(XMM[cpu_rm].d[0]));
        CLOCK_CYCLES(1);
    }
    else
    {
        ...
        double dst_real;
        dst_real = *(double*)&dst;
        setr32(cpu_reg, sse_round_double_to_int(dst_real));
        CLOCK_CYCLES(2);
    }
    return 0;
}
...
static int opCVTPS2DQ_xmm_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3)
    {
        XMM[cpu_reg].l[0] = sse_round_to_int(XMM[cpu_rm].f[0]);
        XMM[cpu_reg].l[1] = sse_round_to_int(XMM[cpu_rm].f[1]);
        XMM[cpu_reg].l[2] = sse_round_to_int(XMM[cpu_rm].f[2]);
        XMM[cpu_reg].l[3] = sse_round_to_int(XMM[cpu_rm].f[3]);
        CLOCK_CYCLES(1);
    }
    else
    {
        ...
        XMM[cpu_reg].l[0] = sse_round_to_int(dst_real[0]);
        XMM[cpu_reg].l[1] = sse_round_to_int(dst_real[1]);
        XMM[cpu_reg].l[2] = sse_round_to_int(dst_real[2]);
        XMM[cpu_reg].l[3] = sse_round_to_int(dst_real[3]);
        CLOCK_CYCLES(2);
    }
    return 0;
}
...
static int opCVTTPS2DQ_xmm_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3)
    {
        XMM[cpu_reg].l[0] = floor(XMM[cpu_rm].f[0]);
        XMM[cpu_reg].l[1] = floor(XMM[cpu_rm].f[1]);
        XMM[cpu_reg].l[2] = floor(XMM[cpu_rm].f[2]);
        XMM[cpu_reg].l[3] = floor(XMM[cpu_rm].f[3]);
        CLOCK_CYCLES(1);
    }
    else
    {
        ...
        dst_real[2] = *(float*)&dst[2];
        dst_real[3] = *(float*)&dst[3];
        XMM[cpu_reg].l[0] = floor(dst_real[0]);
        XMM[cpu_reg].l[1] = floor(dst_real[1]);
        XMM[cpu_reg].l[2] = floor(dst_real[2]);
        XMM[cpu_reg].l[3] = floor(dst_real[3]);
        CLOCK_CYCLES(2);
    }
    return 0;
}
