...
opHADDPS_a16(uint32_t fetchdat)
{
    ...
    tmp.f[2] = XMM[cpu_reg].f[0] + XMM[cpu_reg].f[1];
    tmp.f[3] = XMM[cpu_reg].f[2] + XMM[cpu_reg].f[3];
...
opHADDPD_a16(uint32_t fetchdat)
{
    ...
    tmp.d[1] = XMM[cpu_reg].d[0] + XMM[cpu_reg].d[1];
    XMM[cpu_reg].q[0] = tmp.q[0];
    XMM[cpu_reg].q[1] = tmp.q[1];
    return 0;
}
...
opADDSUBPS_a16(uint32_t fetchdat)
{
    ...
    tmp.f[0] = XMM[cpu_reg].f[0] - src.f[0];
    tmp.f[1] = XMM[cpu_reg].f[1] + src.f[1];
    tmp.f[2] = XMM[cpu_reg].f[2] - src.f[2];
    tmp.f[3] = XMM[cpu_reg].f[3] + src.f[3];
    XMM[cpu_reg].q[0] = tmp.q[0];
    XMM[cpu_reg].q[1] = tmp.q[1];
    return 0;
}
...
opADDSUBPD_a16(uint32_t fetchdat)
{
    ...
    tmp.d[0] = XMM[cpu_reg].d[0] - src.d[0];
    tmp.d[1] = XMM[cpu_reg].d[1] + src.d[1];
    XMM[cpu_reg].q[0] = tmp.q[0];
    XMM[cpu_reg].q[1] = tmp.q[1];
    return 0;
}
