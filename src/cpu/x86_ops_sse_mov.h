...
opMOVUPS_xmm_q_a16(uint32_t fetchdat)
{
    fetch_ea_16(fetchdat);
    if (cpu_mod == 3) {
        cpu_state_high.XMM[cpu_rm].f[0] = cpu_state_high.XMM[cpu_reg].f[0];
        cpu_state_high.XMM[cpu_rm].f[1] = cpu_state_high.XMM[cpu_reg].f[1];
        cpu_state_high.XMM[cpu_rm].f[2] = cpu_state_high.XMM[cpu_reg].f[2];
        cpu_state_high.XMM[cpu_rm].f[3] = cpu_state_high.XMM[cpu_reg].f[3];
        CLOCK_CYCLES(1);
    } else {
...
opMOVSS_xmm_f_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        uint32_t rm = cpu_state_high.XMM[cpu_reg].l[0];
...
opMOVLPS_f_xmm_MOVHLPS_xmm_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        // MOVHLPS
        cpu_state_high.XMM[cpu_reg].q[0] = cpu_state_high.XMM[cpu_rm].q[1];
        CLOCK_CYCLES(1);
    } else {
        // MOVLPS
        uint64_t dst;
...
opUNPCKLPS_f_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        cpu_state_high.XMM[cpu_reg].l[2] = cpu_state_high.XMM[cpu_rm].l[0];
        cpu_state_high.XMM[cpu_reg].l[1] = cpu_state_high.XMM[cpu_reg].l[1];
        ...
        if (cpu_state.abrt)
            return 1;
        cpu_state_high.XMM[cpu_reg].l[0] = cpu_state_high.XMM[cpu_reg].l[0];
        cpu_state_high.XMM[cpu_reg].l[2] = dst[0];
        cpu_state_high.XMM[cpu_reg].l[1] = cpu_state_high.XMM[cpu_reg].l[1];
        cpu_state_high.XMM[cpu_reg].l[3] = dst[1];
        CLOCK_CYCLES(2);
    }
...
opUNPCKHPS_f_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        cpu_state_high.XMM[cpu_reg].l[2] = cpu_state_high.XMM[cpu_rm].l[2];
        cpu_state_high.XMM[cpu_reg].l[1] = cpu_state_high.XMM[cpu_reg].l[3];
        cpu_state_high.XMM[cpu_reg].l[3] = cpu_state_high.XMM[cpu_rm].l[3];
        CLOCK_CYCLES(1);
    } else {
        uint32_t dst[2];
        SEG_CHECK_READ(cpu_state.ea_seg);
...
opUNPCKHPS_f_xmm_a32(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        cpu_state_high.XMM[cpu_reg].l[1] = cpu_state_high.XMM[cpu_rm].l[2];
        cpu_state_high.XMM[cpu_reg].l[3] = cpu_state_high.XMM[cpu_rm].l[3];
        CLOCK_CYCLES(1);
    } else {
        uint32_t dst[2];
        ...
        cpu_state_high.XMM[cpu_reg].l[0] = cpu_state_high.XMM[cpu_reg].l[2];
        cpu_state_high.XMM[cpu_reg].l[2] = cpu_state_high.XMM[cpu_reg].l[3];
        cpu_state_high.XMM[cpu_reg].l[1] = dst[0];
        cpu_state_high.XMM[cpu_reg].l[3] = dst[1];
        CLOCK_CYCLES(2);
    }
    return 0;
...
opPINSRW_xmm_w_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        if (sse_xmm)
            cpu_state_high.XMM[cpu_reg].w[imm & 7] = rm;
        else {
            MMX_ENTER();
            MMX_REG *dst;
            dst = MMX_GETREGP(cpu_reg);
        ...
        if (cpu_state.abrt)
            return 1;
        if (sse_xmm)
            cpu_state_high.XMM[cpu_reg].w[imm & 7] = src;
        else {
            MMX_ENTER();
            MMX_REG *dst;
            dst = MMX_GETREGP(cpu_reg);
...
opSHUFPS_xmm_w_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        SSE_REG tmp;
        tmp.f[0]          = cpu_state_high.XMM[cpu_reg].f[imm & 3];
        tmp.f[1]          = cpu_state_high.XMM[cpu_reg].f[(imm >> 2) & 3];
        tmp.f[2]          = cpu_state_high.XMM[cpu_rm].f[(imm >> 4) & 3];
        tmp.f[3]          = cpu_state_high.XMM[cpu_rm].f[(imm >> 6) & 3];
