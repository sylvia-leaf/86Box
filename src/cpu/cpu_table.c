...
},
{
...
#if defined(DEV_BRANCH) && defined(USE_GENERICINTEL)
    {
        ...
        .cpus          = (const CPU[]) {
            { "100",  CPU_GENERICINTEL, fpus_internal,  100000000,  1.0, 1475, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "200",  CPU_GENERICINTEL, fpus_internal,  200000000,  2.0, 1475, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "300",  CPU_GENERICINTEL, fpus_internal,  300000000,  3.0, 1475, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "400",  CPU_GENERICINTEL, fpus_internal,  400000000,  4.0, 1475, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "500",  CPU_GENERICINTEL, fpus_internal,  500000000,  5.0, 1475, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "600",  CPU_GENERICINTEL, fpus_internal,  600000000,  6.0, 1475, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "700",  CPU_GENERICINTEL, fpus_internal,  700000000,  7.0, 1475, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "800",  CPU_GENERICINTEL, fpus_internal,  800000000,  8.0, 1475, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "900",  CPU_GENERICINTEL, fpus_internal,  900000000,  9.0, 1475, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "1000", CPU_GENERICINTEL, fpus_internal, 1000000000, 10.0, 1475, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "1100", CPU_GENERICINTEL, fpus_internal, 1100000000, 11.0, 1500, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "1200", CPU_GENERICINTEL, fpus_internal, 1200000000, 12.0, 1500, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "1300", CPU_GENERICINTEL, fpus_internal, 1300000000, 13.0, 1500, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "1400", CPU_GENERICINTEL, fpus_internal, 1400000000, 14.0, 1500, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "1500", CPU_GENERICINTEL, fpus_internal, 1500000000, 15.0, 1500, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { .name = "", 0 }
        }
    },
#endif
