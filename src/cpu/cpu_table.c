...
//#ifdef USE_GENERICINTEL
    {
        ...
        .cpus          = (const CPU[]) {
            { "100",  CPU_GENERICINTEL, fpus_internal,  100000000,  1.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 12 },
            { "200",  CPU_GENERICINTEL, fpus_internal,  200000000,  2.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 24 },
            { "300",  CPU_GENERICINTEL, fpus_internal,  300000000,  3.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 36 },
            { "400",  CPU_GENERICINTEL, fpus_internal,  400000000,  4.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 48 },
            { "500",  CPU_GENERICINTEL, fpus_internal,  500000000,  5.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 60 },
            { "600",  CPU_GENERICINTEL, fpus_internal,  600000000,  6.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 72 },
            { "700",  CPU_GENERICINTEL, fpus_internal,  700000000,  7.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 84 },
            { "800",  CPU_GENERICINTEL, fpus_internal,  800000000,  8.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 96 },
            { "900",  CPU_GENERICINTEL, fpus_internal,  900000000,  9.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 108 },
            { "1000", CPU_GENERICINTEL, fpus_internal, 1000000000, 10.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 120 },
            { "1100", CPU_GENERICINTEL, fpus_internal, 1100000000, 11.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 132 },
            { "1200", CPU_GENERICINTEL, fpus_internal, 1200000000, 12.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 144 },
            { "1300", CPU_GENERICINTEL, fpus_internal, 1300000000, 13.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 156 },
            { "1400", CPU_GENERICINTEL, fpus_internal, 1400000000, 14.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 168 },
            { "1500", CPU_GENERICINTEL, fpus_internal, 1500000000, 15.0, 1800, 0x6B4, 0x6B4, 0, 0/*CPU_SUPPORTS_DYNAREC*/, 41, 41, 14, 14, 180 },
            { .name = "", 0 }
        }
    },
//#endif
