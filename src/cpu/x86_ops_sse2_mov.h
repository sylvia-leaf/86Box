...
opMOVUPD_q_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        if (cpu_state.abrt)
            return 1;
        cpu_state_high.XMM[cpu_reg].l[0] = dst[0];
        cpu_state_high.XMM[cpu_reg].l[1] = dst[1];
        cpu_state_high.XMM[cpu_reg].l[2] = dst[2];
        cpu_state_high.XMM[cpu_reg].l[3] = dst[3];
...
opMOVUPD_xmm_q_a16(uint32_t fetchdat)
{
    fetch_ea_16(fetchdat);
    if (cpu_mod == 3) {
        cpu_state_high.XMM[cpu_rm].d[0] = cpu_state_high.XMM[cpu_reg].d[0];
        cpu_state_high.XMM[cpu_rm].d[1] = cpu_state_high.XMM[cpu_reg].d[1];
        CLOCK_CYCLES(1);
    } else {
        uint32_t rm[4] = { cpu_state_high.XMM[cpu_reg].l[0], cpu_state_high.XMM[cpu_reg].l[1], cpu_state_high.XMM[cpu_reg].l[2], cpu_state_high.XMM[cpu_reg].l[3] };
...
opMOVSD_f_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        if (cpu_state.abrt)
            return 1;
        cpu_state_high.XMM[cpu_reg].q[0] = dst;
...
opMOVSD_xmm_f_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        uint64_t rm = cpu_state_high.XMM[cpu_reg].q[0];
...
opMOVLPD_xmm_f_a16(uint32_t fetchdat)
{
    fetch_ea_16(fetchdat);
    if (cpu_mod == 3) {
        cpu_state_high.XMM[cpu_rm].q[0] = cpu_state_high.XMM[cpu_reg].q[0];
        CLOCK_CYCLES(1);
    } else {
        SEG_CHECK_WRITE(cpu_state.ea_seg);
...
opUNPCKLPD_f_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        cpu_state_high.XMM[cpu_reg].q[1] = cpu_state_high.XMM[cpu_rm].q[0];
        CLOCK_CYCLES(1);
    } else {
        uint64_t dst[2];
        SEG_CHECK_READ(cpu_state.ea_seg);
...
opUNPCKHPD_f_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        cpu_state_high.XMM[cpu_reg].q[1] = cpu_state_high.XMM[cpu_rm].q[1];
        CLOCK_CYCLES(1);
    } else {
        uint64_t dst[2];
        SEG_CHECK_READ(cpu_state.ea_seg);
        ...
        if (cpu_state.abrt)
            return 1;
        //uint64_t src = cpu_state_high.XMM[cpu_reg].q[1];
        cpu_state_high.XMM[cpu_reg].q[0] = cpu_state_high.XMM[cpu_reg].q[1];
        cpu_state_high.XMM[cpu_reg].q[1] = dst[1];
        CLOCK_CYCLES(2);
    }
    return 0;
}
...
opMOVHPD_f_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_state.abrt)
        return 1;
    cpu_state_high.XMM[cpu_reg].q[1] = dst;
    CLOCK_CYCLES(2);
    return 0;
}
...
opMOVHPD_xmm_f_a16(uint32_t fetchdat)
{
    fetch_ea_16(fetchdat);
    if (cpu_mod == 3) {
        cpu_state_high.XMM[cpu_rm].q[1] = cpu_state_high.XMM[cpu_reg].q[0];
        CLOCK_CYCLES(1);
    } else {
        SEG_CHECK_WRITE(cpu_state.ea_seg);
        writememq(easeg, cpu_state.eaaddr, cpu_state_high.XMM[cpu_reg].q[1]);
        if (cpu_state.abrt)
            return 1;
        CLOCK_CYCLES(2);
    }
...
opMOVMSKPD_l_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        uint32_t result = 0;
        if (cpu_state_high.XMM[cpu_rm].q[0] & (1ULL << 63))
            result |= 1;
        if (cpu_state_high.XMM[cpu_rm].q[1] & (1ULL << 63))
            result |= 2;
...
opMOVD_l_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        if (cpu_state.abrt)
            return 1;
        cpu_state_high.XMM[cpu_reg].l[0] = dst;
        cpu_state_high.XMM[cpu_reg].l[1] = 0;
        cpu_state_high.XMM[cpu_reg].l[2] = 0;
        cpu_state_high.XMM[cpu_reg].l[3] = 0;
...
opMOVDQA_l_xmm_a16(uint32_t fetchdat)
{
    fetch_ea_16(fetchdat);
    if (cpu_mod == 3) {
        cpu_state_high.XMM[cpu_reg].q[0] = cpu_state_high.XMM[cpu_rm].q[0];
        cpu_state_high.XMM[cpu_reg].q[1] = cpu_state_high.XMM[cpu_rm].q[1];
        CLOCK_CYCLES(1);
    } else {
        uint64_t dst[2];
...
opPSHUFLW_a16(uint32_t fetchdat)
{
    ...
    if (cpu_state.abrt)
        return 1;
    if (cpu_mod == 3) {
        cpu_state_high.XMM[cpu_reg].w[0] = cpu_state_high.XMM[cpu_rm].w[imm & 3];
        cpu_state_high.XMM[cpu_reg].w[1] = cpu_state_high.XMM[cpu_rm].w[(imm >> 2) & 3];
        cpu_state_high.XMM[cpu_reg].w[2] = cpu_state_high.XMM[cpu_rm].w[(imm >> 4) & 3];
        cpu_state_high.XMM[cpu_reg].w[3] = cpu_state_high.XMM[cpu_rm].w[(imm >> 6) & 3];
        cpu_state_high.XMM[cpu_reg].q[1] = cpu_state_high.XMM[cpu_rm].q[1];
        CLOCK_CYCLES(1);
    } else {
        uint64_t src[2];
        ...
        if (cpu_state.abrt)
            return 1;
        cpu_state_high.XMM[cpu_reg].w[0] = (src[0] >> ((imm & 3) << 4)) & 0xffff;
        cpu_state_high.XMM[cpu_reg].w[1] = (src[0] >> (((imm >> 2) & 3) << 4)) & 0xffff;
        cpu_state_high.XMM[cpu_reg].w[2] = (src[0] >> (((imm >> 4) & 3) << 4)) & 0xffff;
        cpu_state_high.XMM[cpu_reg].w[3] = (src[0] >> (((imm >> 6) & 3) << 4)) & 0xffff;
        cpu_state_high.XMM[cpu_reg].q[1] = src[1];
        CLOCK_CYCLES(2);
    }
    return 0;
}
...
opPSHUFHW_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        cpu_state_high.XMM[cpu_reg].q[0] = cpu_state_high.XMM[cpu_rm].q[0];
        cpu_state_high.XMM[cpu_reg].w[4] = cpu_state_high.XMM[cpu_rm].w[(imm & 3) + 4];
        cpu_state_high.XMM[cpu_reg].w[5] = cpu_state_high.XMM[cpu_rm].w[((imm >> 2) & 3) + 4];
        cpu_state_high.XMM[cpu_reg].w[6] = cpu_state_high.XMM[cpu_rm].w[((imm >> 4) & 3) + 4];
        cpu_state_high.XMM[cpu_reg].w[7] = cpu_state_high.XMM[cpu_rm].w[((imm >> 6) & 3) + 4];
        CLOCK_CYCLES(1);
    } else {
        uint64_t src[2];
        ...
        if (cpu_state.abrt)
            return 1;
        cpu_state_high.XMM[cpu_reg].q[0] = src[0];
        cpu_state_high.XMM[cpu_reg].w[4] = (src[1] >> ((imm & 3) << 4)) & 0xffff;
        cpu_state_high.XMM[cpu_reg].w[5] = (src[1] >> (((imm >> 2) & 3) << 4)) & 0xffff;
        cpu_state_high.XMM[cpu_reg].w[6] = (src[1] >> (((imm >> 4) & 3) << 4)) & 0xffff;
        cpu_state_high.XMM[cpu_reg].w[7] = (src[1] >> (((imm >> 6) & 3) << 4)) & 0xffff;
        CLOCK_CYCLES(2);
    }
    return 0;
}
...
opPSHUFD_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        SSE_REG tmp;
        tmp.l[0]          = cpu_state_high.XMM[cpu_rm].l[imm & 3];
        tmp.l[1]          = cpu_state_high.XMM[cpu_rm].l[(imm >> 2) & 3];
        tmp.l[2]          = cpu_state_high.XMM[cpu_rm].l[(imm >> 4) & 3];
        tmp.l[3]          = cpu_state_high.XMM[cpu_rm].l[(imm >> 6) & 3];
...
opMOVD_xmm_l_a16(uint32_t fetchdat)
{
    fetch_ea_16(fetchdat);
    if (cpu_mod == 3) {
        setr32(cpu_rm, cpu_state_high.XMM[cpu_reg].l[0]);
        CLOCK_CYCLES(1);
    } else {
        SEG_CHECK_WRITE(cpu_state.ea_seg);
        CHECK_WRITE_COMMON(cpu_state.ea_seg, cpu_state.eaaddr, cpu_state.eaaddr + 3);
        writememl(easeg, cpu_state.eaaddr, cpu_state_high.XMM[cpu_reg].l[0]);
        if (cpu_state.abrt)
            return 1;
        CLOCK_CYCLES(2);
    }
...
opMOVDQA_xmm_q_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        cpu_state_high.XMM[cpu_rm].q[0] = cpu_state_high.XMM[cpu_reg].q[0];
        cpu_state_high.XMM[cpu_rm].q[1] = cpu_state_high.XMM[cpu_reg].q[1];
        CLOCK_CYCLES(1);
    } else {
        if (cpu_state.eaaddr & 0xf) {
            x86gpf(NULL, 0);
        ...
        if (cpu_state.abrt)
            return 1;
        writememq(easeg, cpu_state.eaaddr + 8, cpu_state_high.XMM[cpu_reg].q[1]);
        if (cpu_state.abrt)
            return 1;
        CLOCK_CYCLES(2);
    }
...
opSHUFPD_xmm_w_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        SSE_REG tmp;
        tmp.q[0] = cpu_state_high.XMM[cpu_reg].q[imm & 1];
        tmp.q[1] = cpu_state_high.XMM[cpu_rm].q[(imm >> 1) & 1];
        cpu_state_high.XMM[cpu_reg].q[0] = tmp.q[0];
        cpu_state_high.XMM[cpu_reg].q[1] = tmp.q[1];
        CLOCK_CYCLES(1);
    } else {
...
opMOVQ_q_xmm_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        SEG_CHECK_READ(cpu_state.ea_seg);
        CHECK_WRITE_COMMON(cpu_state.ea_seg, cpu_state.eaaddr, cpu_state.eaaddr + 7);
        cpu_state_high.XMM[cpu_reg].q[0] = readmemq(easeg, cpu_state.eaaddr);
        if (cpu_state.abrt)
            return 1;
        cpu_state_high.XMM[cpu_reg].q[1] = 0;
        CLOCK_CYCLES(2);
...
opMASKMOVDQU_a16(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        ...
        if (cpu_state_high.XMM[cpu_rm].b[0] & (1 << 7)) {
            writememb(ds, DI, cpu_state_high.XMM[cpu_reg].b[0]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[1] & (1 << 7)) {
            writememb(ds, DI + 1, cpu_state_high.XMM[cpu_reg].b[1]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[2] & (1 << 7)) {
            writememb(ds, DI + 2, cpu_state_high.XMM[cpu_reg].b[2]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[3] & (1 << 7)) {
            writememb(ds, DI + 3, cpu_state_high.XMM[cpu_reg].b[3]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[4] & (1 << 7)) {
            writememb(ds, DI + 4, cpu_state_high.XMM[cpu_reg].b[4]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[5] & (1 << 7)) {
            writememb(ds, DI + 5, cpu_state_high.XMM[cpu_reg].b[5]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[6] & (1 << 7)) {
            writememb(ds, DI + 6, cpu_state_high.XMM[cpu_reg].b[6]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[7] & (1 << 7)) {
            writememb(ds, DI + 7, cpu_state_high.XMM[cpu_reg].b[7]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[8] & (1 << 7)) {
            writememb(ds, DI + 8, cpu_state_high.XMM[cpu_reg].b[8]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[9] & (1 << 7)) {
            writememb(ds, DI + 9, cpu_state_high.XMM[cpu_reg].b[9]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[10] & (1 << 7)) {
            writememb(ds, DI + 10, cpu_state_high.XMM[cpu_reg].b[10]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[11] & (1 << 7)) {
            writememb(ds, DI + 11, cpu_state_high.XMM[cpu_reg].b[11]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[12] & (1 << 7)) {
            writememb(ds, DI + 12, cpu_state_high.XMM[cpu_reg].b[12]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[13] & (1 << 7)) {
            writememb(ds, DI + 13, cpu_state_high.XMM[cpu_reg].b[13]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[14] & (1 << 7)) {
            writememb(ds, DI + 14, cpu_state_high.XMM[cpu_reg].b[14]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[15] & (1 << 7)) {
            writememb(ds, DI + 15, cpu_state_high.XMM[cpu_reg].b[15]);
            if (cpu_state.abrt)
                return 1;
        }
        CLOCK_CYCLES(1);
...
opMASKMOVDQU_a32(uint32_t fetchdat)
{
    ...
    if (cpu_mod == 3) {
        SEG_CHECK_WRITE(cpu_state.ea_seg);
        if (cpu_state_high.XMM[cpu_rm].b[0] & (1 << 7)) {
            writememb(ds, EDI, cpu_state_high.XMM[cpu_reg].b[0]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[1] & (1 << 7)) {
            writememb(ds, EDI + 1, cpu_state_high.XMM[cpu_reg].b[1]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[2] & (1 << 7)) {
            writememb(ds, EDI + 2, cpu_state_high.XMM[cpu_reg].b[2]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[3] & (1 << 7)) {
            writememb(ds, EDI + 3, cpu_state_high.XMM[cpu_reg].b[3]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[4] & (1 << 7)) {
            writememb(ds, EDI + 4, cpu_state_high.XMM[cpu_reg].b[4]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[5] & (1 << 7)) {
            writememb(ds, EDI + 5, cpu_state_high.XMM[cpu_reg].b[5]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[6] & (1 << 7)) {
            writememb(ds, EDI + 6, cpu_state_high.XMM[cpu_reg].b[6]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[7] & (1 << 7)) {
            writememb(ds, EDI + 7, cpu_state_high.XMM[cpu_reg].b[7]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[8] & (1 << 7)) {
            writememb(ds, EDI + 8, cpu_state_high.XMM[cpu_reg].b[8]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[9] & (1 << 7)) {
            writememb(ds, EDI + 9, cpu_state_high.XMM[cpu_reg].b[9]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[10] & (1 << 7)) {
            writememb(ds, EDI + 10, cpu_state_high.XMM[cpu_reg].b[10]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[11] & (1 << 7)) {
            writememb(ds, EDI + 11, cpu_state_high.XMM[cpu_reg].b[11]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[12] & (1 << 7)) {
            writememb(ds, EDI + 12, cpu_state_high.XMM[cpu_reg].b[12]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[13] & (1 << 7)) {
            writememb(ds, EDI + 13, cpu_state_high.XMM[cpu_reg].b[13]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[14] & (1 << 7)) {
            writememb(ds, EDI + 14, cpu_state_high.XMM[cpu_reg].b[14]);
            if (cpu_state.abrt)
                return 1;
        }
        if (cpu_state_high.XMM[cpu_rm].b[15] & (1 << 7)) {
            writememb(ds, EDI + 15, cpu_state_high.XMM[cpu_reg].b[15]);
            if (cpu_state.abrt)
                return 1;
        }
        CLOCK_CYCLES(1);
