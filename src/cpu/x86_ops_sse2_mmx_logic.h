...
static int opPOR_xmm_a16(uint32_t fetchdat)
{
        SSE_REG src;
...
static int opPOR_xmm_a32(uint32_t fetchdat)
{
        SSE_REG src;
...
static int opPXOR_xmm_a16(uint32_t fetchdat)
{
        SSE_REG src;
...
static int opPXOR_xmm_a32(uint32_t fetchdat)
{
        SSE_REG src;
